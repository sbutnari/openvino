...
if(ENABLE_INTEL_NPU_COMPILER)
    ...
    if(NPU_PLUGIN_COMPILER)
        ...
        install(FILES ${PLUGIN_COMPILER_LIB} DESTINATION tests COMPONENT ${NPU_PLUGIN_COMPONENT})
        install(FILES ${PLUGIN_COMPILER_LOADER_LIB} DESTINATION tests COMPONENT ${NPU_PLUGIN_COMPONENT})
